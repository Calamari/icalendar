defmodule ICalendar do
  ...
  defdelegate from_ics(string), to: ICalendar.Decoder
  defdelegate to_ics(object), to: ICalendar.Encoder
  ...
  @props %{
    ...
    prodid: %{default: :text},
    # TODO: detect
    rdate: %{default: :date_time, allowed: [:date_time, :date, :period], multi: ","},
